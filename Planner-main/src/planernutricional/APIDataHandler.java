...
// Clase que recibe un nombre de alimento, fetchea la informacion del alimento y, dependiendo de las
// preferencias del usuario, llama a la clase LDH para almacenarlo
public class APIDataHandler {
  // Declaracion de variables
  List<String> nutrientIDs;
  LocalDataHandler LDH;
  String nutrientIDs_s = "", values = "";
