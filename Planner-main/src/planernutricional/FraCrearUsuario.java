...
public class FraCrearUsuario extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    panCrearUsuario.add(
        btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(167, 62, 155, 63));
    ...
    panCrearUsuario.add(
        btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 62, 155, 63));
    panCrearUsuario.add(
        txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 6, 212, -1));
    panCrearUsuario.add(
        txtPeso, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 34, 212, -1));

    getContentPane()
        .add(panCrearUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(-4, -4, 330, 130));
